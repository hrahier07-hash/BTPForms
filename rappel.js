          ...
          <div style="font-family: 'IBM Plex Sans', sans-serif; max-width: 560px; margin: 0 auto; padding: 32px; background: #f7f7fa; border-radius: 16px;">
            <div style="background: #fff; border-radius: 12px; padding: 32px; border: 1px solid #e4e4e7;">
              <div style="margin-bottom: 24px;">
                <span style="display: inline-block; background: #3282DE; color: #fff; font-size: 12px; font-weight: 700; padding: 4px 12px; border-radius: 20px; letter-spacing: 0.05em; text-transform: uppercase;">Nouvelle demande de rappel</span>
              </div>
              <h2 style="font-size: 22px; font-weight: 800; color: #111827; margin: 0 0 24px; letter-spacing: -0.02em;">
                ${prenom} ${nom} souhaite être rappelé(e)
              </h2>
              ...
              <div style="margin-top: 28px; padding: 16px; background: #eef5ff; border-radius: 10px; border: 1px solid rgba(50,130,222,.2);">
                <p style="margin: 0; font-size: 13px; color: #2268C0; font-weight: 500;">
                  📞 À rappeler sous 24h ouvrées au <strong>${tel}</strong>
                </p>
              </div>
            </div>
